...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    {
        return $container->services['PrestaShop\\ModuleLibCacheDirectoryProvider\\Cache\\CacheDirectoryProvider'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('9.0.0', 'C:\\wamp64\\www\\prestashop', false);
    }
    ...
    {
        return $container->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, 'C:\\wamp64\\www\\prestashop/var/cache/prod\\/localization');
    }
    ...
    {
        return $container->services['ps_checkout.cache.filesystem.paypal.capture'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('paypal-capture', 3600, ($container->services['PrestaShop\\ModuleLibCacheDirectoryProvider\\Cache\\CacheDirectoryProvider'] ??= new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('9.0.0', 'C:\\wamp64\\www\\prestashop', false))->getPath());
    }
    ...
    {
        return $container->services['ps_checkout.cache.filesystem.paypal.order'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('paypal-orders', 3600, ($container->services['PrestaShop\\ModuleLibCacheDirectoryProvider\\Cache\\CacheDirectoryProvider'] ??= new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('9.0.0', 'C:\\wamp64\\www\\prestashop', false))->getPath());
    }
    ...
    protected static function getDotEnvLayerService($container, $lazyLoad = true)
    {
        ...
        return ($lazyLoad->__construct(($container->services['prestashop.adapter.environment'] ??= new \PrestaShop\PrestaShop\Adapter\Environment(false, 'prod', 'front')), 'C:\\wamp64\\www\\prestashop') && false ?: $lazyLoad);
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, ['C:\\wamp64\\www\\prestashop\\src\\PrestaShopBundle\\Entity']), 'PrestaShop');
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, ['C:\\wamp64\\www\\prestashop\\modules\\productcomments\\src\\Entity']), 'PrestaShop\\Module\\ProductComment\\Entity');
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, ['C:\\wamp64\\www\\prestashop\\modules\\ps_accounts\\src\\Entity']), 'PrestaShop\\Module\\PsAccounts\\Entity');
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, ['C:\\wamp64\\www\\prestashop\\modules\\ps_checkout\\src\\Entity']), 'PrestaShop\\Module\\PrestashopCheckout\\Entity');
        ...
        $instance->setProxyDir('C:\\wamp64\\www\\prestashop/var/cache/prod\\/doctrine/orm/Proxies');
