...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    {
        return $container->services['PrestaShop\\ModuleLibCacheDirectoryProvider\\Cache\\CacheDirectoryProvider'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('9.0.0', 'C:\\wamp64\\www\\prestashop', true);
    }
    ...
    {
        return $container->services['PrestaShop\\Module\\PrestashopCheckout\\Logger\\LoggerDirectory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('9.0.0', 'C:\\wamp64\\www\\prestashop');
    }
    ...
    {
        return $container->services['prestashop.adapter.module.repository.module_repository'] = new \PrestaShop\PrestaShop\Adapter\Module\Repository\ModuleRepository('C:\\wamp64\\www\\prestashop', 'C:\\wamp64\\www\\prestashop/modules/');
    }
    ...
    {
        return $container->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, 'C:\\wamp64\\www\\prestashop/var/cache/dev\\/localization');
    }
    ...
    {
        return $container->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy(($container->services['annotation_reader'] ??= new \Doctrine\Common\Annotations\AnnotationReader()), '6wgzx_');
    }
    ...
    {
        return $container->services['prestashop.translation.translator_language_loader'] = new \PrestaShopBundle\Translation\TranslatorLanguageLoader(($container->services['prestashop.adapter.module.repository.module_repository'] ??= new \PrestaShop\PrestaShop\Adapter\Module\Repository\ModuleRepository('C:\\wamp64\\www\\prestashop', 'C:\\wamp64\\www\\prestashop/modules/')));
    }
    ...
    {
        return $container->services['product_comment_criterion_repository'] = new \PrestaShop\Module\ProductComment\Repository\ProductCommentCriterionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)), ($container->services['doctrine.dbal.default_connection'] ?? self::getDoctrine_Dbal_DefaultConnectionService($container)), '6wgzx_');
    }
    ...
    {
        return $container->services['product_comment_repository'] = new \PrestaShop\Module\ProductComment\Repository\ProductCommentRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)), ($container->services['doctrine.dbal.default_connection'] ?? self::getDoctrine_Dbal_DefaultConnectionService($container)), '6wgzx_', ($container->services['PrestaShop\\PrestaShop\\Adapter\\Configuration'] ??= new \PrestaShop\PrestaShop\Adapter\Configuration())->get("PRODUCT_COMMENTS_ALLOW_GUESTS"), ($container->services['PrestaShop\\PrestaShop\\Adapter\\Configuration'] ??= new \PrestaShop\PrestaShop\Adapter\Configuration())->get("PRODUCT_COMMENTS_MINIMAL_TIME"));
    }
    ...
    {
        return $container->services['ps_checkout.cache.filesystem.paypal.capture'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('paypal-capture', 3600, ($container->services['PrestaShop\\ModuleLibCacheDirectoryProvider\\Cache\\CacheDirectoryProvider'] ??= new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('9.0.0', 'C:\\wamp64\\www\\prestashop', true))->getPath());
    }
    ...
    {
        return $container->services['ps_checkout.cache.filesystem.paypal.order'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('paypal-orders', 3600, ($container->services['PrestaShop\\ModuleLibCacheDirectoryProvider\\Cache\\CacheDirectoryProvider'] ??= new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('9.0.0', 'C:\\wamp64\\www\\prestashop', true))->getPath());
    }
    ...
    protected static function getDotEnvLayerService($container, $lazyLoad = true)
    {
        ...
        return ($lazyLoad->__construct(($container->services['prestashop.adapter.environment'] ??= new \PrestaShop\PrestaShop\Adapter\Environment(true, 'dev', 'front')), 'C:\\wamp64\\www\\prestashop') && false ?: $lazyLoad);
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($b, ['C:\\wamp64\\www\\prestashop\\src\\PrestaShopBundle\\Entity']), 'PrestaShop');
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($b, ['C:\\wamp64\\www\\prestashop\\modules\\productcomments\\src\\Entity']), 'PrestaShop\\Module\\ProductComment\\Entity');
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($b, ['C:\\wamp64\\www\\prestashop\\modules\\ps_accounts\\src\\Entity']), 'PrestaShop\\Module\\PsAccounts\\Entity');
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($b, ['C:\\wamp64\\www\\prestashop\\modules\\ps_checkout\\src\\Entity']), 'PrestaShop\\Module\\PrestashopCheckout\\Entity');
        ...
        $instance->setProxyDir('C:\\wamp64\\www\\prestashop/var/cache/dev\\/doctrine/orm/Proxies');
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'prestashop.module_dir' => 'C:\\wamp64\\www\\prestashop/modules/',
